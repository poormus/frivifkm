...
class EventChatScreenNavigated extends StatefulWidget {
  final CurrentUserData currentUserData;
  final String eventId;
  final String eventName;

  const EventChatScreenNavigated(
      {Key? key,
...
class _EventChatScreenState extends State<EventChatScreenNavigated> {
  ...
  Future uploadEventChat() async {
    ...
    eventService.createEventChat(widget.eventId, widget.currentUserData.uid,
              ...
              return Column(
                children: [
                  Container(
                    ...
                    child: Center(
                      child:
                          Text('This is the very beginning of your chat'.tr()),
                    ),
                  ),
                  Spacer(),
...
class EventChatMessageTile extends StatelessWidget {
  ...
  const EventChatMessageTile(
      ...
      required this.otherNames, required this.provider,required this.uid})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final userName=Utils.getUserName(currentUser.userName, currentUser.userSurname);
