...
class MyTasks extends StatelessWidget {
  ...
  List<Task> getTasks(String taskProgress){
    ...
    tasks.forEach((element) {
      if(element.progress==taskProgress && element.assignees.contains(currentUserData.uid)){
  ...
  Widget buildListTile(String element,int index){
    ...
    switch(index){
      case 0:
        widget=ListTile(title: Text(element,style: TextStyle(color: Colors.grey)),trailing: Text(length,style: TextStyle(color: Colors.grey)));
        break;
      case 1:
                        ...
                        Row(
                          children: [
                            ...
                            ElevatedCustomButton(
                              text: task.assignees.contains(currentUserData.uid)?'Drop task'.tr():'Pick task'.tr(),
                              press: (){
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Text('${task.assignees.length}/${task.maxUsersForOpenTask}'),
                            SizedBox(width: 5),
                            ElevatedCustomButton(text: 'Complete task'.tr(), press: (){
